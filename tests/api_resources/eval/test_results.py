...
class TestResults:
    ...
    def test_streaming_response_retrieve_results(self, client: Bem) -> None:
        with client.eval.results.with_streaming_response.retrieve_results() as response:
...
class TestAsyncResults:
    ...
    async def test_streaming_response_retrieve_results(self, async_client: AsyncBem) -> None:
        async with async_client.eval.results.with_streaming_response.retrieve_results() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
