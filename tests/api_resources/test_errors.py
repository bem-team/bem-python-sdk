...
from bem.types import ErrorListResponse, ErrorRetrieveResponse
...
class TestErrors:
    ...
    def test_method_retrieve(self, client: Bem) -> None:
        ...
        assert_matches_type(ErrorRetrieveResponse, error, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve(self, client: Bem) -> None:
        response = client.errors.with_raw_response.retrieve(
            "eventID",
        )
    ...
    def test_streaming_response_retrieve(self, client: Bem) -> None:
        with client.errors.with_streaming_response.retrieve(
            "eventID",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Bem) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `event_id` but received ''"):
            client.errors.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_list(self, client: Bem) -> None:
        error = client.errors.list()
        assert_matches_type(ErrorListResponse, error, path=["response"])
    ...
    def test_raw_response_list(self, client: Bem) -> None:
        response = client.errors.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Bem) -> None:
        with client.errors.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncErrors:
    ...
    async def test_method_retrieve(self, async_client: AsyncBem) -> None:
        error = await async_client.errors.retrieve(
            "eventID",
        )
        assert_matches_type(ErrorRetrieveResponse, error, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBem) -> None:
        response = await async_client.errors.with_raw_response.retrieve(
            "eventID",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncBem) -> None:
        async with async_client.errors.with_streaming_response.retrieve(
            "eventID",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncBem) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `event_id` but received ''"):
            await async_client.errors.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_list(self, async_client: AsyncBem) -> None:
        error = await async_client.errors.list()
        assert_matches_type(ErrorListResponse, error, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBem) -> None:
        response = await async_client.errors.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBem) -> None:
        async with async_client.errors.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
