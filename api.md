...
```python
from bem.types import ErrorEvent, InboundEmailEvent, ErrorRetrieveResponse, ErrorListResponse
```
...
- <code title="get /v3/errors">client.errors.<a href="./src/bem/resources/errors.py">list</a>(\*\*<a href="src/bem/types/error_list_params.py">params</a>) -> <a href="./src/bem/types/error_list_response.py">ErrorListResponse</a></code>
...
```python
from bem.types import AnyType, Event, OutputRetrieveResponse, OutputListResponse
```
...
- <code title="get /v3/outputs">client.outputs.<a href="./src/bem/resources/outputs.py">list</a>(\*\*<a href="src/bem/types/output_list_params.py">params</a>) -> <a href="./src/bem/types/output_list_response.py">OutputListResponse</a></code>
...
```python
from bem.types.workflows import VersionRetrieveResponse, VersionListResponse
```
...
- <code title="get /v3/workflows/{workflowName}/versions">client.workflows.versions.<a href="./src/bem/resources/workflows/versions.py">list</a>(workflow_name, \*\*<a href="src/bem/types/workflows/version_list_params.py">params</a>) -> <a href="./src/bem/types/workflows/version_list_response.py">VersionListResponse</a></code>
