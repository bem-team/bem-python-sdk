...
from .time_window_param import TimeWindowParam
...
__all__ = ["ViewGenerateAggregationDataParams"]


class ViewGenerateAggregationDataParams(TypedDict, total=False):
    ...
    time_window: Required[Annotated[TimeWindowParam, PropertyInfo(alias="timeWindow")]]
