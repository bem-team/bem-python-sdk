...
__all__ = [
    ...
    "UpsertClassifyFunctionClassification",
    "UpsertClassifyFunctionClassificationOrigin",
    "UpsertClassifyFunctionClassificationOriginEmail",
    "UpsertClassifyFunctionClassificationRegex",
    "UpsertSendFunction",
    "UpsertSplitFunction",
...
class UpsertClassifyFunction(TypedDict, total=False):
    ...
    classifications: Iterable[UpsertClassifyFunctionClassification]
...
class UpsertClassifyFunctionClassificationOriginEmail(TypedDict, total=False):
    patterns: SequenceNotStr[str]


class UpsertClassifyFunctionClassificationOrigin(TypedDict, total=False):
    email: UpsertClassifyFunctionClassificationOriginEmail


class UpsertClassifyFunctionClassificationRegex(TypedDict, total=False):
    patterns: SequenceNotStr[str]


class UpsertClassifyFunctionClassification(TypedDict, total=False):
    name: Required[str]
    ...
    origin: UpsertClassifyFunctionClassificationOrigin

    regex: UpsertClassifyFunctionClassificationRegex
