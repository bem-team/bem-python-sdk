...
__all__ = ["EvalTriggerEvaluationParams"]


class EvalTriggerEvaluationParams(TypedDict, total=False):
    ...
    """Optional evaluation version (e.g.

    `0.1.0-gemini`). When omitted the server's default evaluation version is used.
    """
