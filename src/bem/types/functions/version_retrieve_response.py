...
__all__ = [
    ...
    "Function",
    "FunctionTransformFunctionVersion",
    "FunctionExtractFunctionVersion",
    "FunctionAnalyzeFunctionVersion",
    "FunctionClassifyFunctionVersion",
    "FunctionClassifyFunctionVersionClassification",
    "FunctionClassifyFunctionVersionClassificationOrigin",
    "FunctionClassifyFunctionVersionClassificationOriginEmail",
    "FunctionClassifyFunctionVersionClassificationRegex",
    "FunctionSendFunctionVersion",
    "FunctionSplitFunctionVersion",
    "FunctionSplitFunctionVersionPrintPageSplitConfig",
    "FunctionSplitFunctionVersionSemanticPageSplitConfig",
    "FunctionJoinFunctionVersion",
    "FunctionEnrichFunctionVersion",
    "FunctionPayloadShapingFunctionVersion",
]


class FunctionTransformFunctionVersion(BaseModel):
...
class FunctionExtractFunctionVersion(BaseModel):
    function_id: str = FieldInfo(alias="functionID")
    """Unique identifier of function."""
...
class FunctionAnalyzeFunctionVersion(BaseModel):
...
class FunctionClassifyFunctionVersionClassificationOriginEmail(BaseModel):
    patterns: Optional[List[str]] = None


class FunctionClassifyFunctionVersionClassificationOrigin(BaseModel):
    email: Optional[FunctionClassifyFunctionVersionClassificationOriginEmail] = None


class FunctionClassifyFunctionVersionClassificationRegex(BaseModel):
    patterns: Optional[List[str]] = None


class FunctionClassifyFunctionVersionClassification(BaseModel):
    name: str
    ...
    origin: Optional[FunctionClassifyFunctionVersionClassificationOrigin] = None

    regex: Optional[FunctionClassifyFunctionVersionClassificationRegex] = None


class FunctionClassifyFunctionVersion(BaseModel):
    """
    V3 read-side shape of a Classify (internally Route) function version.
    Mirrors {
    """

    classifications: List[FunctionClassifyFunctionVersionClassification]
...
class FunctionSendFunctionVersion(BaseModel):
...
class FunctionSplitFunctionVersionPrintPageSplitConfig(BaseModel):
    next_function_id: Optional[str] = FieldInfo(alias="nextFunctionID", default=None)


class FunctionSplitFunctionVersionSemanticPageSplitConfig(BaseModel):
    item_classes: Optional[List[SplitFunctionSemanticPageItemClass]] = FieldInfo(alias="itemClasses", default=None)


class FunctionSplitFunctionVersion(BaseModel):
    function_id: str = FieldInfo(alias="functionID")
    """Unique identifier of function."""
    ...
    print_page_split_config: Optional[FunctionSplitFunctionVersionPrintPageSplitConfig] = FieldInfo(
        alias="printPageSplitConfig", default=None
    )

    semantic_page_split_config: Optional[FunctionSplitFunctionVersionSemanticPageSplitConfig] = FieldInfo(
...
class FunctionJoinFunctionVersion(BaseModel):
    description: str
...
class FunctionEnrichFunctionVersion(BaseModel):
    config: EnrichConfig
...
class FunctionPayloadShapingFunctionVersion(BaseModel):
    """
