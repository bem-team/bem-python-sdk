...
__all__ = [
    ...
    "PrintPageOutputItem",
    "SemanticPageOutput",
    "SemanticPageOutputItem",
    "Metadata",
]


class PrintPageOutputItem(BaseModel):
...
class PrintPageOutput(BaseModel):
    ...
    items: Optional[List[PrintPageOutputItem]] = None


class SemanticPageOutputItem(BaseModel):
...
class SemanticPageOutput(BaseModel):
    ...
    items: Optional[List[SemanticPageOutputItem]] = None
...
class SplitCollectionWebhookEvent(BaseModel):
    ...
    print_page_output: PrintPageOutput = FieldInfo(alias="printPageOutput")
    ...
    semantic_page_output: SemanticPageOutput = FieldInfo(alias="semanticPageOutput")
